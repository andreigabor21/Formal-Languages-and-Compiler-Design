...
class ParserRecursiveDescendent:
    ...
    def get_situation(self):
        with open(self.out_file, 'a') as f:
            ...
            f.write(str(self.working_stack) + "\n")
            f.write(str(self.input_stack) + "\n")

    def init_out_file(self): #creates the given file
    ...
    def another_try(self):
        ...
        last = self.working_stack.pop()  # (nt, production_nr)
    ...
    def print_working(self):
        ...
        self.write_in_out(str(self.working_stack))
